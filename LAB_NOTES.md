# Lab 03 — Recorded Results (for the report / paper)

All DBSCAN runs are on the scaled TRAINING split (618 points), min_samples=8,
unless stated otherwise.

## Part 1 — DBSCAN

### Baseline: eps=0.06 (scaled features) — THE COMMITTED CONFIGURATION
```
3 clusters; 33 noise
